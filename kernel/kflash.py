    ...
    def process(self, terminal=True, dev="", baudrate=1500000, board=None, sram = False, file="", callback=None, noansi=False, terminal_auto_size=False, terminal_size=(50, 1), slow_mode = False):
        ...
        class MAIXLoader:
            ...
            def __init__(self, port='/dev/ttyUSB1', baudrate=115200):
                # configure the serial connections (the parameters differs on the driver you are connecting to)
            ...
            def load_elf_to_sram(self, f):
                ...
                if elffile['e_entry'] != 0x80000000:
                    KFlash.log(WARN_MSG,"ELF platform is 0x%x instead of 0x80000000" % (elffile['e_entry']), BASH_TIPS['DEFAULT'])
        ...
        if args.port == "DEFAULT":
            if args.Board == "goE":
                ...
                try:
                    list_port_info = next(serial.tools.list_ports.grep(VID_LIST_FOR_AUTO_LOOKUP)) #Take the first one within the cstl
        ...
        if file_format == ProgramFileFormat.FMT_KFPKG:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                fFlashList = open(os.path.join(tmpdir, 'flash-cstl.json'), "r")
